  ...
  presets: [
    ...
    presetIcons({
      ...
      collections: {
        custom: {
          symbol:
            '<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24"> <path d="M20.27 3.73c-2.114-2.115-5.475-2.466-8.27-.067-2.795-2.4-6.156-2.048-8.27.067C1.615 5.844 1.264 9.205 3.663 12c-2.4 2.795-2.048 6.156.067 8.27 2.114 2.115 5.475 2.466 8.27.067 2.795 2.4 6.156 2.048 8.27-.067 2.115-2.114 2.466-5.475.067-8.27 2.4-2.795 2.048-6.156-.067-8.27Z"/> </svg> ',
        },
      },
    }),
    presetAttributify(),
